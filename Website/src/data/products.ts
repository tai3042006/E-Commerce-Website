...
// In-memory products state (no localStorage dependency)
let productsState: Product[] = [...defaultProducts];

export const getProducts = (): Product[] => [...productsState];

export const getProduct = (id: string): Product | undefined =>
  productsState.find((p) => p.id === id);
